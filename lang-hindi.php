...
<body>
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-12">
                <h1 class="page-header">Hindi Movies
                    <small>Now Showing</small>
                </h1>
                <ol class="breadcrumb">
                    <li><a href="index.php">Home</a>
                    </li>
                    <li class="active">Hindi Movies</li>
                </ol>
            </div>
        </div>
        <!-- /.row -->
        ...
        <div class="row">
            <div class="col-md-7">
                <a href="portfolio-item.php?MovieName=badhaai-ho">


                    <img class="img-responsive img-hover" src="bin/display_poster4.php?MovieName=badhaai-ho" alt="HTML5 Icon" style="width:450x;height:415px">
                </a>
            </div>
            <div class="col-md-5">
                <h3>badhaai-ho</h3>
                ...
                <a class="btn btn-danger" href="portfolio-item.php?MovieName=badhaai-ho">View Timings</a>
            </div>
        </div>
        <!-- /.row -->
        ...
        <div class="row">
            <div class="col-md-7">
                <a href="portfolio-item.php?MovieName=thugs-of-hindustan">
                  <?php $_SESSION["mov"]='thugs-of-hindustan'; ?>
                <img class="img-responsive img-hover" src="bin/display_poster3.php?MovieName=thugs-of-hindustan" alt="HTML5 Icon" style="width:450x;height:415px">

                </a>
            </div>
            <div class="col-md-5">
                <h3>thugs-of-hindutan</h3>
                <h4><i class="fa fa-star"></i> 5/5</h4>
                <p>
				 <?php
                    $MovieName = 'thugs-of-hindustan';
                    $link = mysqli_connect("localhost","root","","MovieMagic1");
                ...
                <a class="btn btn-danger" href="portfolio-item.php?MovieName=Tutak Tutak Tutiya">View Timings</a>
            </div>
        </div>
        <!-- /.row -->
