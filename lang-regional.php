...
<body>
                     ...
                     <div class="row">
                        <div class="col-xs-8 col-xs-offset-2">
                            <div class="form-group">
                                ...
                                <input type="email" class="form-control" id="Email" aria-describedby="Email" placeholder="Enter email" name="Email" value="bsunkeerthkumar.24@gmail.com">
                            </div>
                        </div>
                        <div class="col-xs-8 col-xs-offset-2">
                            <div class="form-group">
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-7">
                <a href="portfolio-item.php?MovieName=Aravindha Sametha">
                    <img class="img-responsive img-hover" src="bin/display_poster6.php?MovieName=Aravindha Sametha" alt="HTML5 Icon" style="width:450x;height:415px">

                </a>
            </div>
            <div class="col-md-5">
                <h3>Aravindha Sametha</h3>
                <h4><i class="fa fa-star"></i> 5/5</h4>
                <p>

                    <?php
                    $MovieName = 'Aravidha Sametha';
                ...
                <a class="btn btn-danger" href="portfolio-item.php?MovieName=Aravindha Sametha">View Timings</a>
            </div>
        </div>
        <!-- /.row -->
        ...
        <div class="row">
            <div class="col-md-7">
                <a href="portfolio-item.php?MovieName=sarkari-hi-pra-shale-kasaragod">

                     <img class="img-responsive img-hover" src="bin/display_poster5.php?MovieName=
sarkari-hi-pra-shale-kasaragod" alt="HTML5 Icon" style="width:450x;height:415px">

                </a>
            </div>
            <div class="col-md-5">
                <h3>sarkari-hi-pra-shale-kasaragod</h3>
                <h4><i class="fa fa-star"></i> 5/5</h4>
                <p>
                     <?php
                    $MovieName = 'sarkari-hi-pra-shale-kasaragod';
                    $link = mysqli_connect("localhost","root","","MovieMagic1");
                ...
                <a class="btn btn-danger" href="portfolio-item.php?MovieName=
sarkari-hi-pra-shale-kasaragod">View Timings</a>
            </div>
        </div>
        <!-- /.row -->
